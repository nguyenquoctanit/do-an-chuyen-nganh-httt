...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 24, 2019 lúc 02:21 PM
...
(151, 71368671, 'quoctan', 1, 'dathang', '2019-04-24 14:12:30'),
(152, 71368668, 'quoctan', 1, 'dathang', '2019-04-24 14:13:20');
...
(14, 'Nguyễn Quốc Tấn', 'Bach Khoa ĐN', 'quoctan.it.bkdn@gmail.com', 354998542, 2345245, 'đà nẵng', 'Đề nghị nhân viên phục vụ có thái độ tốt hơn đối với khách hàng', '2013-12-20 09:19:30');
...
('Quốc Tấn', 'Đà Nẵng', 'quoctan.it.bkdn@gmail.com', 354998542, 'Admin', '86e6075b9c1dcae75660adf0cf803fb5', 1, 1),
('Nguyễn Quốc Tấn', 'Huế', 'nqt.it.bk@gmail.com', 379935828, 'quoctan', '101450cb1ecbe1a82e37027fcf07a862', 1, 3);
...
--
ALTER TABLE `giohang`
  MODIFY `id_giohang` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
